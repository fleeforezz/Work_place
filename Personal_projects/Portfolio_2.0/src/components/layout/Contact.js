...
export default function Contact() {
    ...
    return (
        <motion.section id="contact" className="px-[2rem]"
            variants={banner}
            initial="initial"
            animate={mainControls}
        >
            <motion.h1 className="flex gap-10 justify-center items-center font-medium text-center text-[#8c8c73] text-[8vw] max-sm:text-[10vw] pt-[45px] max-sm:pt-10"
            ...
            <div ref={ref} className="flex max-md:flex-wrap justify-around">
                <div className="max-md:px-[2rem]">
                ...
                <div className="max-md:w-[100%] max-md:px-5">
                    ...
                    <div className="mt-10 max-md:mt-5">
                        ...
                        >
                            ...
                            <a href="https://gitlab.fleeforezz.site/jso" target="_blank" className="gitlab flex items-center gap-2 mt-5 mb-5">
