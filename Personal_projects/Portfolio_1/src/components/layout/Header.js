...
export default function Header() {
    return (
        <header id="/">
            <div>
                <nav className="flex fixed md:flex-row flex-col w-full items-center justify-around mx-auto p-4 backdrop-blur shadow-sm shadow-navigation_box_shadow z-50">
                    <nav className="flex">
