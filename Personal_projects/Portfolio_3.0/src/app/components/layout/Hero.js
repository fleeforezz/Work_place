    ...
    return (
        <section className="relative flex flex-col gap-[5rem] px-[20px] bg-[--dark-background]">
            ...
            <div className="container_3 grid grid-cols-12">
                ...
                <a href="#about" className="more col-start-12 col-span-2 flex flex-col items-center justify-center">
                    <Image src={"arrow-up-right.svg"} width={32} height={32} alt="arrow-up-right" />
                    More about me
                </a>
            </div>

            <Image src={"star.svg"} width={180} height={180} alt="star" className="absolute top-[30px] left-[70%] -z-10 animate-spin"/>
